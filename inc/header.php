...
<!-- Add the button code snippet here -->
<head>
<style>
...
<a href="admin/login.php" class="admin-button" target="_blank">Admin</a>
...
<body>
  ...
  <div class="wrap">
    <div class="header_top">
      <div class="logo">
      <img src="images/gabriel.png" alt="Logo">
...
<div class="menu">
  <ul id="dc_mega-menu-orange" class="dc_mm-orange">
    ...
    <li><a href="topbrands.php">Top Books</a></li>
    <?php 
...
<?php
 ...
 ?>
    ...
    <li><a href="contact.php">Sell book</a> </li>
