...
class Product
{
    ...
    public function latestFromCluster()
    {
    ...
    public function latestFromTensflow()
    {
    ...
    public function latestFromDocker()
    {
